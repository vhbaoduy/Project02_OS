...
// -----------------------------------------------------------------------------------
	...
	// read Buffer tu vung nho cua User
	// -> sao chep vung nho tu User sang vung nho cua System
	// duoc viet o file translate.cc
    int System2User(int virtAddr,int len,char* buffer);
	// write buffer vao vung nho cua User
	// -> sao chep vung nho tu System sang vung nho cua User
	// duoc viet o file translate.cc
	
    void IncreaseProgramCounter();
	// tang program counter cua System len 4 byte de nap cac lenh tiep theo
	// duoc viet o file machine.cc
